...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef SmalllaserAmmo => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Example_Weapon_AmmoBased",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 20f,
                        Width = 0.5f,
                        Color = Color(red: 2f, green: 0f, blue: 10f, alpha: 1),
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Color = Color(red: 1f, green: 0.5f, blue: 15f, alpha: 1),
                            WidthMultiplier = 1f,
                            Reverse = false,
